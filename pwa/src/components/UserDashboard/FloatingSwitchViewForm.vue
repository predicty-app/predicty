...
const optionsButtons: OptionsType[] = [
  ...
  },
  {
    ...
    'label': t('components.user-dashboard.floating-switch-view-form.option-ad-collection')
  }
]
...
<template>
  <FloatingPanel class="absolute bottom-5 left-0 right-0 m-auto" :options="optionsButtons" @on-click="handleChangeView"

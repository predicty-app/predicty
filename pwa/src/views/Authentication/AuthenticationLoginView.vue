...
const forgotStepPath = "/onboarding/authentication/reset-password";
const signupStepPath = "/onboarding/account-creation/email";
</script>
...
<template>
  <OnBoardingLayout>
    ...
    <template #content>
      <HeaderText :header-title="t('views.authentication-login.header-title')" :header-description="
        t('views.authentication-login.header-description')
      " />
      <AuthenticationLoginForm />
      <div class="text-base flex items-center justify-between">
        <button class="font-bold cursor-pointer underline" @click="router.push(forgotStepPath)">
          {{ t('views.authentication-login.buttons.forgot') }}
        </button>
        <div class="flex justify-center items-center gap-x-1">
          {{ t('views.authentication-login.buttons.sign-up.description') }}
          <button class="font-bold cursor-pointer underline" @click="router.push(signupStepPath)">
